...
exports.extractCharacter = extractCharacter;
exports.extractCharacterExpansion = extractCharacterExpansion;
exports.extractCharacterFromMarkdown = extractCharacterFromMarkdown;
/**
 ...
 */
function extractCharacter(aiResponse) {
    try {
 ...
 */
function extractCharacterExpansion(aiResponse, expansionType) {
    try {
        // Find JSON in the response
        const jsonMatch = aiResponse.match(/\{[\s\S]*\}/);
        if (!jsonMatch)
 ...
 */
function extractCharacterFromMarkdown(aiResponse) {
    try {
        const character = {
            physicalTraits: [],
            personalityTraits: [],
